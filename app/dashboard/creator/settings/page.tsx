    ...
    <div className="min-h-screen bg-[#FFF5F5]">
      ...
      <div className="px-4 pb-8 space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
          ...
          <button
            onClick={() => router.push('/dashboard/creator/settings/change-password')}
            className="w-full flex items-center justify-between px-5 py-4 border-b border-gray-100 hover:bg-gray-50 transition-colors"
          >
          ...
          <button
            onClick={() => router.push('/dashboard/creator/settings/notifications')}
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
          <button
            onClick={() => router.push('/dashboard/creator/settings/help')}
            className="w-full flex items-center justify-between px-5 py-4 border-b border-gray-100 hover:bg-gray-50 transition-colors"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-between px-5 py-4 hover:bg-gray-50 transition-colors"
          >
            <span className="text-base font-medium text-gray-900">Write a Review</span>
            <ChevronRight size={20} className="text-gray-400" />
          </button>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
          <button
            ...
            className="w-full flex items-center justify-between px-5 py-4 border-b border-gray-100 hover:bg-gray-50 transition-colors"
          >
            <span className="text-base font-medium text-gray-900">Terms of Use</span>
            <ChevronRight size={20} className="text-gray-400" />
          </button>
