  ...
  return (
    <div className="min-h-screen bg-[#F5F0EB]">
      <header className="px-4 py-3 flex items-center justify-between bg-white shadow-sm">
        ...
        <h1 className="text-lg font-semibold text-[#000000]">Frequently Asked Questions</h1>
        <button
          type="button"
      ...
      <div className="px-4 pt-6 space-y-4">
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-[#E5E7EB]">
          <p className="text-base text-[#6B7280]">
            FAQ content will be loaded from your backend or CMS. Add common questions and answers here.
          </p>
        </div>
      </div>
    </div>
